...
#### 2015-2038
>Of course, the farther ahead in time you try to look, the harder it is and the more speculative it gets. But here are two future possibilities if we had another bull run gold cycle, assuming a longer timeframe (double the last cycle). Two different charts are shown here:
>### Scenario 1: 500% Gain
